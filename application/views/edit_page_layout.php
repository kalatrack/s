...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
			<div class="well">
			<section>
	<?php $button = anchor('admin/page', '<button class="btn btn-info">Cancel</button>'); ?>
		<div class="modal-body">
<h2><?php echo empty($page->id) ? 'Add a new page ': 'Edit page : '.$page->title.'<br>'.$button; ?></h2>
	...
	<?php echo form_open(); ?>
		...
		<div class="text-danger"><?php echo validation_errors(); ?></div>
			<table class="table table-striped">
				<tr> 
				<!-- parent child relation in between pages and sub pages  -->
<td class=" text-primary">Parent</td>
